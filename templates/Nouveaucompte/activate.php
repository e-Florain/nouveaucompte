...
<div class="row">
    <div class="col-sm-10">
        ...
        if ($account_cyclos) {
            if ($action_needed) {
                echo "<h5>Votre pièce d'identité n'a pu être validée automatique, elle sera donc analysée manuellement. Les délais de votre création de compte seront de 24 à 48h en jours ouvrables.</h5>";
            }
